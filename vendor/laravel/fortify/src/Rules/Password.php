    ...
    public function message()
    {
        ...
        switch (true) {
            case $this->requireUppercase
                ...
                return __('A :attribute deve ter pelo menos :length caracteres e conter ao menos uma letra maiúscula.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                ...
                && ! $this->requireSpecialCharacter:
                return __('A :attribute deve conter ao menos :length caracteres e conter ao menos um número.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireSpecialCharacter
                && ! $this->requireUppercase
                && ! $this->requireNumeric:
                return __('A :attribute deve conter ao menos :length caracteres e conter ao menos caractere especial.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && ! $this->requireSpecialCharacter:
                return __('A :attribute deve conter ao menos :length caracteres e conter ao menos uma letra maiúscula e um número.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireSpecialCharacter
                && ! $this->requireNumeric:
                return __('A :attribute deve conter ao menos :length caracteres e conter ao menos uma letra maiúscula e um caractere especial.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                && $this->requireNumeric
                && $this->requireSpecialCharacter:
                return __('A :attribute deve conter ao menos :length caracteres e conter ao menos uma letra maiúscula, um número, e um caractere especial.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                && $this->requireSpecialCharacter
                && ! $this->requireUppercase:
                return __('A :attribute deve conter ao menos :length caracteres e conter ao menos e um caractere especial e um número.', [
                    'length' => $this->length,
                ]);

            default:
                return __('A :attribute deve conter ao menos :length caracteres.', [
                    'length' => $this->length,
                ]);
        }
    }
